...
pub fn map_phys_err(err_set: &mut StateErrSet, a: &PhysState, b: &PhysState, include_rot: bool) {
    ...
    err_set.push(("ang_vel".to_string(), calc_vec_err(a.ang_vel, b.ang_vel) / 5.0));
}
...
pub fn map_car_err(a: &CarState, b: &CarState) -> StateErrSet {
    ...
    if a.is_demoed || b.is_demoed {
        ...
        err_set.push(("is_demoed".to_string(), calc_bool_err(a.is_demoed, b.is_demoed)));
        return err_set;
    }

    err_set.push(("boost".to_string(), (a.boost - b.boost).abs() / consts::BOOST_MAX));
    err_set.push(("is_on_ground".to_string(), calc_bool_err(a.is_on_ground, b.is_on_ground)));
    err_set.push(("is_jumping".to_string(), calc_bool_err(a.is_jumping, b.is_jumping)));
    err_set.push(("has_jumped".to_string(), calc_bool_err(a.has_jumped, b.has_jumped)));
    err_set.push(("is_flipping".to_string(), calc_bool_err(a.is_flipping, b.is_flipping)));
    err_set.push(("has_flipped".to_string(), calc_bool_err(a.is_flipping, b.has_flipped)));
    err_set.push(("has_double_jumped".to_string(), calc_bool_err(a.has_double_jumped, b.has_double_jumped)));
    err_set.push(("air_time".to_string(), calc_time_err(a.air_time, b.air_time)));
    err_set.push(("air_time_since_jump".to_string(), calc_time_err(a.air_time_since_jump, b.air_time_since_jump)));

    err_set.push(("has_hit_ball".to_string(), calc_bool_err(a.ball_hit_info.is_some(), b.ball_hit_info.is_some())));

    // NOTE: Have to do these by hand because the strings must all be static
    err_set.push(("wheel_0_contact".to_string(), calc_bool_err(a.wheels_with_contact[0], b.wheels_with_contact[0])));
    err_set.push(("wheel_1_contact".to_string(), calc_bool_err(a.wheels_with_contact[1], b.wheels_with_contact[1])));
    err_set.push(("wheel_2_contact".to_string(), calc_bool_err(a.wheels_with_contact[2], b.wheels_with_contact[2])));
    err_set.push(("wheel_3_contact".to_string(), calc_bool_err(a.wheels_with_contact[3], b.wheels_with_contact[3])));
