...
pub fn resolve_single_collision(
    body1: &RigidBody,
    body1_co: &CollisionObject,
    body2: &RigidBody,
    body2_co: &CollisionObject,
    contact_position_world: Vec3A,
    contact_normal_on_b: Vec3A,
    solver_info: &ContactSolverInfo,
    distance: f32,
) -> f32 {
    let rel_pos1 = contact_position_world - body1_co.get_world_transform().translation;
    let rel_pos2 = contact_position_world - body2_co.get_world_transform().translation;
...
pub fn resolve_single_bilateral(
    ...
    let body1_comt = body1_co.get_world_transform();
    let body2_comt = body2_co.get_world_transform();
