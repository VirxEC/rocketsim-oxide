...
use crate::{bullet::linear_math::vector3::Vector3, math::LinearPieceCurve};
...
pub const CAR_AIR_CONTROL_TORQUE: Vector3 = Vector3::new(130., 95., 400.);
pub const CAR_AIR_CONTROL_DAMPING: Vector3 = Vector3::new(30., 20., 50.);
...
pub mod heatseeker {
    ...
    pub const BALL_START_POS: Vector3 = Vector3::new(-1000., -2220., 92.75);
    pub const BALL_START_VEL: Vector3 = Vector3::new(0., -65., 650.);
}
...
pub mod boostpads {
    ...
    pub const LOCS_SMALL_SOCCAR: [Vector3; LOCS_AMOUNT_SMALL_SOCCAR as usize] = [
        Vector3::new(0., -4240., 70.),
        Vector3::new(-1792., -4184., 70.),
        Vector3::new(1792., -4184., 70.),
        Vector3::new(-940., -3308., 70.),
        Vector3::new(940., -3308., 70.),
        Vector3::new(0., -2816., 70.),
        Vector3::new(-3584., -2484., 70.),
        Vector3::new(3584., -2484., 70.),
        Vector3::new(-1788., -2300., 70.),
        Vector3::new(1788., -2300., 70.),
        Vector3::new(-2048., -1036., 70.),
        Vector3::new(0., -1024., 70.),
        Vector3::new(2048., -1036., 70.),
        Vector3::new(-1024., 0., 70.),
        Vector3::new(1024., 0., 70.),
        Vector3::new(-2048., 1036., 70.),
        Vector3::new(0., 1024., 70.),
        Vector3::new(2048., 1036., 70.),
    ...
    pub const LOCS_BIG_SOCCAR: [Vector3; LOCS_AMOUNT_BIG as usize] = [
        Vector3::new(-3584., 0., 73.),
        Vector3::new(3584., 0., 73.),
        Vector3::new(-3072., 4096., 73.),
        Vector3::new(3072., 4096., 73.),
        Vector3::new(-3072., -4096., 73.),
        Vector3::new(3072., -4096., 73.),
    ];
    pub const LOCS_BIG_HOOPS: [Vector3; LOCS_AMOUNT_BIG as usize] = [
        Vector3::new(-2176., 2944., 72.),
        Vector3::new(2176., -2944., 72.),
        Vector3::new(-2176., -2944., 72.),
        Vector3::new(-2432., 0., 72.),
        Vector3::new(2432., 0., 72.),
        Vector3::new(2175.99, 2944., 72.),
    ];
    pub const LOCS_SMALL_HOOPS: [Vector3; LOCS_AMOUNT_SMALL_HOOPS as usize] = [
        Vector3::new(1536., -1024., 64.),
        Vector3::new(-1280., -2304., 64.),
        Vector3::new(0., -2816., 64.),
        Vector3::new(-1536., -1024., 64.),
        Vector3::new(1280., -2304., 64.),
        Vector3::new(-512., 512., 64.),
        Vector3::new(-1536., 1024., 64.),
        Vector3::new(1536., 1024., 64.),
        Vector3::new(1280., 2304., 64.),
        Vector3::new(0., 2816., 64.),
