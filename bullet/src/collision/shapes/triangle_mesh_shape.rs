...
pub struct TriangleMeshShape {
    ...
    pub mesh_interface: Rc<dyn StridingMeshInterface>,
}

impl TriangleMeshShape {
    pub fn new(mesh_interface: Rc<dyn StridingMeshInterface>) -> Self {
...
impl TriangleCallback for SupportVertexCallback {
    fn process_triangle(&mut self, triangle: &[Vec3A], _part_id: usize, _triangle_index: usize) {
